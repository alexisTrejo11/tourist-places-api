...
@Operation(
    ...
    description = "Delete one of your own reviews. You can only delete reviews you created. **Requires authentication**. This action cannot be undone.",
...
public @interface DeleteUserReviewOperation {
}
