...
@Operation(
    ...
    description = "Permanently remove a user account from the system using their unique identifier. **Requires ADMIN role**. This action cannot be undone.",
    ...
    @ApiResponse(
        ...
        content = @Content(
            ...
            examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
                ...
                value = ApiResponseExamples.USER_DELETED
            )
        )
    ),
    @ApiResponse(
