...
@Operation(
    ...
    description = "Permanently remove a review from the system using its unique identifier. The system automatically updates the tourist place's average rating. **Requires ADMIN role**. This action cannot be undone.",
    ...
    @ApiResponse(
        ...
        content = @Content(
            ...
            examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
                ...
                value = ApiResponseExamples.REVIEW_DELETED
            )
        )
    ),
    @ApiResponse(
