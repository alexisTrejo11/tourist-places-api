...
@Operation(
    ...
    description = "Remove one or more tourist places from an existing place list. **Requires authentication**.",
    security = @SecurityRequirement(name = "bearerAuth")
)
@ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Places removed successfully",
        content = @Content(
...
public @interface RemovePlacesFromListOperation {
}
