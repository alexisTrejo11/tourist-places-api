...
@Operation(
    ...
    description = "Retrieve a comprehensive list of all reviews in the system. Returns all reviews with details including rating, comment, author, and associated tourist place. **Requires ADMIN role**.",
...
public @interface GetAllReviewsOperation {
}
