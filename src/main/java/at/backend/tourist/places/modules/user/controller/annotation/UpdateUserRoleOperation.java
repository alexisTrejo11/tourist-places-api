...
@Operation(
    ...
    description = "Change the role of an existing user (USER or ADMIN). **Requires ADMIN role**.",
    ...
    @ApiResponse(
        ...
        content = @Content(
            ...
            examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
                ...
                value = ApiResponseExamples.SUCCESS
            )
        )
    ),
    @ApiResponse(
...
public @interface UpdateUserRoleOperation {
}
