...
@Operation(
    ...
    description = "Permanently remove a country from the system using its unique identifier. **Requires ADMIN role**. This action cannot be undone.",
    ...
    @ApiResponse(
        ...
        content = @Content(
            ...
            examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
                ...
                value = ApiResponseExamples.COUNTRY_DELETED
            )
        )
    ),
    @ApiResponse(
...
public @interface DeleteCountryOperation {
}
