...
@Operation(
    summary = "Delete a place list by ID",
    description = "Permanently remove a place list from the system using its unique identifier. **Requires ADMIN role**. This action cannot be undone.",
...
public @interface DeletePlaceListOperation {
}
