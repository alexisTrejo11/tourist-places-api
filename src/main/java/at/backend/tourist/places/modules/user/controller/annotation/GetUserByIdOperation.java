...
@Operation(
    ...
    description = "Retrieve detailed information about a specific user using their unique identifier. Returns complete user profile including name, email, role, and account status. **Requires ADMIN role**.",
    ...
    @ApiResponse(
        ...
        content = @Content(
            ...
            examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
                ...
                value = ApiResponseExamples.USER
            )
        )
    ),
    @ApiResponse(
